...
class UssdController extends Controller
{
    public function __invoke(Request $request)
    {
        return Ussd::build(
            ...
            ->with(['phone_number' => $request->input('msisdn')])
        )
...
class Speso implements Configurator
{
    public function configure(Ussd $ussd): void
    {
        $ussd->useResponse(SpesoResponse::class);
    }
}
```
