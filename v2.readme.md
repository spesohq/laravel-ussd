...
You can use configurator to simplify repetitive parts of your application so they can be shared easily. Just implement and `Speso\Ussd\Contracts\Configurator` interface and use it in your machine.
```php
<?php
...
This file contains the full V2 documentation. See the [main README](./readme.md) for current V3 usage.
...
[ico-travis]: https://img.shields.io/travis/spesohq/laravel-ussd/master.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/speso/laravel-ussd
[link-travis]: https://travis-ci.com/spesohq/laravel-ussd
